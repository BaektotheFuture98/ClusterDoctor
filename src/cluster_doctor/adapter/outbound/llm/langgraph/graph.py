...
from cluster_doctor.adapter.outbound.llm.langgraph.nodes import (
    LlmCaller,
    make_analyze_minute,
    make_synthesize,
    split_by_minute,
)
from cluster_doctor.adapter.outbound.llm.langgraph.state import GraphState
...
def build_graph(call_llm: LlmCaller):
    """컴파일된 그래프를 돌려준다.
    ...
    builder.add_node(_ANALYZE_MINUTE, make_analyze_minute(call_llm))
