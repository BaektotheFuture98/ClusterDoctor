...
def _build_tools(seams: DiagnosisSeams, delegation: _DiagnosisSession) -> list:
...
def _evidence_digest(delegation: _DiagnosisSession, *, cached: bool) -> dict:
...
def _verification_of(delegation: _DiagnosisSession) -> VerificationStatus:
